...
- [al-folio](#al-folio)
  ...
  - [Local Hosting (this branch)](#local-hosting-this-branch)
    - [What's different from main](#whats-different-from-main)
    - [Prerequisites](#prerequisites)
    - [Setup &amp; run](#setup--run)
    - [Run in the background (survives closing the terminal)](#run-in-the-background-survives-closing-the-terminal)
